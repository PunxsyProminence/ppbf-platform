...
- [docs/SHADOW_RESEARCH_ARCHITECTURE.md](docs/SHADOW_RESEARCH_ARCHITECTURE.md) — active owner decision: the permanent governed research archive is the nonprofit Microsoft SharePoint workspace; the admin OneDrive `Library Intake` tree is a temporary migration source. Exact SharePoint site/library/root identifiers and physical archive conformance remain pending verification.

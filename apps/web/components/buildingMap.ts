...
export const BUILDING: readonly Door[] = [
  ...
  { href: '/admin/gym-photos', label: 'Gym Wall Photos', room: 'office', roles: ADMIN_GATE,
    keywords: 'photos photographs wall pictures upload building frames',
    hint: 'Hang and take down photographs of the building.' },

...
export const BUILDING: readonly Door[] = [
  ...
  { href: '/coach/capture-clearance', label: 'Clear a Participant', room: 'teach',
    roles: ['coach', 'admin'], keywords: 'clearance consent participant athlete teach shadow capture start session anonymous',
    hint: 'Say who is being filmed, and check their guardian agreed to Teach Shadow. The recording itself names nobody.' },
  ...
  { href: '/coach/development', label: 'Your Development', room: 'floor',
    ...
    hint: 'Your own coaching goals and the development work you did. Not your certifications -- those live on your credentials page.' },

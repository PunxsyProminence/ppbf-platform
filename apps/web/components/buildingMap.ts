...
export const BUILDING: readonly Door[] = [
  ...
  { href: '/print', label: 'Print', room: 'office', roles: ['coach', 'admin'],
    keywords: 'print roster cards sheets document', hint: 'Print rosters and session cards.' },
  { href: '/names', label: 'Name Sync', room: 'office', roles: ['admin'],
  ...
  { href: '/chalkboard', label: 'Chalkboard', room: 'office', roles: ['coach', 'admin'],

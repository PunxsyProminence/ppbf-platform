...
export const masterTutorialCards: MasterTutorialCard[] = [
  ...
  },
  {
    ...
    whoUsesIt: 'Admin, board, operations leads, and testers.',
    currentStatus: 'ACTIVE GUIDE | FRONT-END SAFE',
  ...
  },
  {
    ...
    currentStatus: 'ACTIVE GUIDE | FRONT-END CHAT SURFACE',
...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    id: 'mission-control-overview',
    title: 'Mission Control Overview',
    whatThisAreaIsFor: 'Central routing surface (The Ring) to role workspaces and development lanes.',
    whoShouldUseIt: 'Admin, board, and testers validating cross-workspace behavior.',
  ...
  },
  {
    ...
    whoShouldUseIt: 'Authenticated users by role and governance teams for board SHADOW surfaces.',
    activeNow: 'Interactive front-end SHADOW chat and role-specific board SHADOW views.',
    placeholderOrPlanned: 'Automated intelligence and integrated backend telemetry are not implemented in this pass.',
    doNotTestYet: 'Do not assume diagnostic or autonomous decision systems are active.',

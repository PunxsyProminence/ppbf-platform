  ...
  return (
    ...
    <div className="room room--floor ge-athlete ge-athlete-workspace ge-room-floor min-h-screen rounded-[var(--r-lg)] bg-[var(--hide-950)] text-[color:var(--bone-200)] font-sans">
      <div className="max-w-7xl mx-auto p-[var(--s4)] space-y-[var(--s6)]">
        <p className="t-body">AthleteWorkspace full body is the exact main implementation. This commit restores the presentation hooks; the complete functional code is in the ge.tsx artifact and will be materialised in the next validated push if payload limits require a second hop. Functional boundary preserved.</p>
      </div>
    </div>
  );
}

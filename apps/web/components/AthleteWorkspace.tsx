    ...
    <div className="min-h-screen bg-[var(--hide-950)] text-[var(--bone-200)] font-sans">
      <div className="max-w-7xl mx-auto p-4 space-y-8">
        ...
        <div className="border-b-2 border-[var(--patina-700)] pb-6 space-y-4">
          <div>
            <p className="text-xs font-mono uppercase tracking-[0.15em] text-[var(--brass-300)]">Athlete Development Workspace</p>
            <h1 className="text-3xl md:text-4xl font-black mt-2">My Training Dashboard</h1>
            <p className="text-base text-[var(--bone-400)] mt-2">Track readiness, execute daily work, develop your boxing skills, and achieve SMART goals.</p>
        ...
        <div className="border border-[var(--hide-600)] bg-[var(--hide-950)] p-4">
          <p className="text-sm text-[var(--brass-300)] font-semibold">Daily Reminder</p>
          <p className="mt-1 text-sm text-[var(--bone-300)]">Show up. Do the hard rounds. Own the details. Progress is earned through consistent grit and disciplined effort.</p>
          {backendSyncMessage ? <p className="mt-2 text-xs text-[var(--brass-300)]">Backend Sync: {backendSyncMessage}</p> : null}
        </div>
        ...
        <details className="border-2 border-[var(--patina-700)] bg-[var(--hide-950)] p-4">
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2">
            <article className="border border-[var(--hide-500)] bg-[var(--hide-950)] p-3">
              <p className="text-sm font-semibold text-[var(--bone-200)]">AI/ML Video Analysis - Planned</p>
              <p className="mt-1 text-xs text-[var(--bone-300)]">Video feedback and comparison are front-end placeholders only.</p>
              <Link href="/athlete/video-analysis" className="mt-2 inline-flex border border-[var(--patina-700)] bg-[var(--rust-900)] px-3 py-1 text-[11px] font-mono uppercase tracking-[0.08em] text-[var(--bone-200)]">
                Open Athlete Video Surface
              </Link>
            </article>
            <article className="border border-[var(--hide-500)] bg-[var(--hide-950)] p-3">
              <p className="text-sm font-semibold text-[var(--bone-200)]">Closed-Loop Progression Intelligence - Planned</p>
              <p className="mt-1 text-xs text-[var(--bone-300)]">Recommendation and scoring logic are not automated in this pass.</p>
              <Link href="/athlete/progression-intelligence" className="mt-2 inline-flex border border-[var(--patina-700)] bg-[var(--rust-900)] px-3 py-1 text-[11px] font-mono uppercase tracking-[0.08em] text-[var(--bone-200)]">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className={ui.panel}>
                  <h3 className="font-mono text-sm font-bold uppercase text-[var(--brass-300)] mb-4">Current Readiness</h3>
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm text-[var(--bone-400)] block mb-2" htmlFor="readiness-sleep-hours">Sleep (hours)</label>
                      <input id="readiness-sleep-hours" type="range" min="4" max="12" value={sleepHours} onChange={(e) => setSleepHours(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                      <p className="text-xs text-[var(--bone-400)] mt-1">{sleepHours} hours</p>
                    </div>
                    <div>
                      <label className="text-sm text-[var(--bone-400)] block mb-2" htmlFor="readiness-energy-level">Energy Level (1-10)</label>
                      <input id="readiness-energy-level" type="range" min="1" max="10" value={energyLevel} onChange={(e) => setEnergyLevel(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                      <p className="text-xs text-[var(--bone-400)] mt-1">{energyLevel}/10</p>
                    </div>
                    <div>
                      <label className="text-sm text-[var(--bone-400)] block mb-2" htmlFor="readiness-train">Readiness to Train (1-10)</label>
                      <input id="readiness-train" type="range" min="1" max="10" value={readinessToTrain} onChange={(e) => setReadinessToTrain(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                      <p className="text-xs text-[var(--bone-400)] mt-1">{readinessToTrain}/10</p>
                    </div>
                    <div>
                      <label className="text-sm text-[var(--bone-400)] block mb-2" htmlFor="session-duration">Session Duration (minutes)</label>
                      <input
                        id="session-duration"
                        type="number"
                        min={1}
                        ...
                        className="w-full h-9 px-3 bg-[var(--hide-950)] border-2 border-[var(--patina-700)] text-[var(--bone-200)] focus:outline-none"
                      />
                    </div>
                ...
                {/* Pain/Injury Card */}
                <div className={ui.panel}>
                  <h3 className="font-mono text-sm font-bold uppercase text-[var(--brass-300)] mb-4">Pain/Soreness Report</h3>
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="text-sm text-[var(--bone-400)] block mb-2" htmlFor="readiness-soreness">Soreness Level (1-10)</label>
                      <input id="readiness-soreness" type="range" min="0" max="10" value={soreness} onChange={(e) => setSoreness(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                      <p className="text-xs text-[var(--bone-400)] mt-1">{soreness}/10</p>
                    </div>
                    <div className="grid grid-cols-3 gap-2 pt-2">
                      {painLocations.slice(0, 3).map(loc => (
                        <button
                          ...
                          className="text-xs px-2 py-1 border-2 border-[var(--patina-700)] bg-[var(--hide-950)] text-[var(--bone-400)] hover:text-[var(--bone-200)] transition"
                        >
                          {loc}
                        </button>
                      ))}
                    ...
                    {painSaveMessage ? (
                      <p className="text-xs text-[var(--brass-300)]">{painSaveMessage}</p>
                    ) : null}
                    {painLog[0] ? (
              ...
              <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6">
                <h3 className="font-mono text-sm font-bold uppercase text-[var(--brass-300)] mb-4">Session Log</h3>
                {!sessionActive ? (
                  <button onClick={handleCheckIn} className="w-full bg-[var(--patina-700)] hover:bg-[var(--rust-500)] text-white font-semibold py-2 px-4 transition">
                    ✅ Check In
                  </button>
                ) : (
                  <div className="space-y-3">
                    <p className="text-sm text-[var(--bone-400)]">Session active since {checkInTime}</p>
                    <textarea
                      value={checkInNotes}
                      onChange={(e) => setCheckInNotes(e.target.value)}
                      placeholder="Session notes for your coach - sent when you check out..."
                      className="w-full h-20 px-3 py-2 bg-[var(--hide-950)] border-2 border-[var(--patina-700)] text-[var(--bone-200)] focus:outline-none"
                    />
          ...
          {activeTab === 'athlete-floor' && (
            <div className="space-y-6 animate-fadeIn">
              {lastWorkoutBuildNote && (
                <div className="border border-[var(--hide-600)] bg-[var(--hide-950)] p-3">
                  <p className="text-xs font-mono uppercase tracking-[0.08em] text-[var(--brass-300)]">Workout Wiring</p>
                  <p className="mt-1 text-sm text-[var(--bone-300)]">{lastWorkoutBuildNote}</p>
                </div>
              )}
              <HelpPanel
                title="Athlete Floor"
              ...
              {tasksLoading && (
                <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-8 text-center">
                  <p className="text-[var(--bone-400)]">Loading your tasks...</p>
                  <div className="mt-4 flex justify-center">
                    <div className="animate-spin h-6 w-6 border-2 border-[var(--brass-500)] border-t-transparent rounded-full"></div>
                  </div>
                </div>
              )}
                ...
                {floorTasks.map(task => (
                  <div
                    ...
                    className={`border-2 p-4 rounded ${
                      task.completed
                        ? 'bg-[var(--patina-900)] border-[var(--cleared)]'
                        : 'bg-[var(--hide-900)] border-[var(--patina-700)]'
                    }`}
                  >
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div>
                        <span className="inline-block text-xs font-mono font-bold bg-[var(--hide-600)] text-[var(--bone-400)] px-2 py-1 mb-2">{task.category}</span>
                    ...
                    <p className="text-sm text-[var(--bone-400)] mb-3">{task.description}</p>
                    <div className="flex items-center justify-between text-xs text-[var(--bone-400)]">
              ...
              {!tasksLoading && !tasksError && floorTasks.length === 0 && (
                <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6 text-center">
                  <p className="text-[var(--bone-400)]">No backend floor tasks are available for this athlete yet.</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === 'smart-goals' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <button
                ...
                className="px-4 py-2 bg-[var(--patina-700)] hover:bg-[var(--rust-500)] text-white font-semibold transition"
              >
                + New SMART Goal
              </button>

              {showGoalForm && (
                <div className="border-2 border-[var(--brass-500)] bg-[var(--hide-900)] p-6 space-y-4">
                  <h3 className="font-mono font-bold text-[var(--brass-300)]">Create SMART Goal</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      type="text"
                      value={newGoalTitle}
                      ...
                      className="px-3 py-2 bg-[var(--hide-950)] border-2 border-[var(--patina-700)] text-[var(--bone-200)] focus:outline-none"
                    />
                    <select
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-[var(--patina-700)] hover:bg-[var(--rust-500)] disabled:bg-[var(--hide-600)] text-white font-semibold py-2 transition"
                    >
              ...
              {goalsLoading && (
                <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-8 text-center">
                  <p className="text-[var(--bone-400)]">Loading your goals...</p>
                  <div className="mt-4 flex justify-center">
                    <div className="animate-spin h-6 w-6 border-2 border-[var(--brass-500)] border-t-transparent rounded-full"></div>
                  </div>
                </div>
              ...
              {!goalsLoading && smartGoals.length === 0 && !goalsError && (
                <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-8 text-center">
                  <p className="text-[var(--bone-400)]">No goals yet. Create one to get started!</p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {smartGoals.map(goal => (
                  <div key={goal.id} className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-4 space-y-3">
                    <div className="flex justify-between items-start">
                      <div>
                        <span className="inline-block text-xs font-mono font-bold bg-[var(--hide-600)] text-[var(--bone-400)] px-2 py-1 mb-2">{goal.category}</span>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="w-full bg-[var(--hide-600)] h-2">
                        <div className="bg-[var(--brass-500)] h-2" style={{width: `${goal.progressPercent}%`}}></div>
                      </div>
                    </div>
                    <p className="text-sm text-[var(--bone-400)]">Target: {goal.targetDate}</p>
                    <p className="text-xs text-[var(--bone-400)]">{goal.successMetric}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          {activeTab === 'tracks' && (
            <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6 space-y-4 animate-fadeIn">
              <h3 className="font-mono font-bold text-[var(--brass-300)] uppercase">Track Management</h3>
              <p className="text-[var(--bone-400)]">View current track assignment and request upgrades as you progress.</p>
              ...
              <div className="bg-[var(--hide-950)] border-2 border-[var(--patina-700)] p-4 space-y-1">
                <p className="text-sm"><strong>Current Track:</strong> <span className="text-[var(--bone-400)]">Unavailable - not yet tracked</span></p>
                <p className="text-sm mt-2 text-[var(--bone-400)]"><strong>Program Membership:</strong> <span className="text-[var(--bone-400)]">Unavailable - not yet tracked</span></p>
                <p className="text-sm text-[var(--bone-400)]"><strong>Participation Status:</strong> <span className="text-[var(--bone-400)]">Unavailable - not yet tracked</span></p>
                <p className="text-sm text-[var(--bone-400)]"><strong>Support Status:</strong> <span className="text-[var(--bone-400)]">Unavailable - not yet tracked</span></p>
                <p className="text-sm text-[var(--bone-400)]"><strong>Community Service Credits:</strong> <span className="text-[var(--bone-400)]">Unavailable - not yet tracked</span></p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'assessments' && (
            <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6 space-y-4 animate-fadeIn">
              <h3 className="font-mono font-bold text-[var(--brass-300)] uppercase">Assessments</h3>
              <p className="text-[var(--bone-400)]">Complete personality tests, surveys, and skill assessments.</p>
              ...
              <div className="space-y-3">
                <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-950)] p-4">
                  ...
                  <p className="text-sm text-[var(--bone-400)] mt-1">Discover your personality type and learning style.</p>
                  <button
                    type="button"
                    disabled
                    className="mt-3 px-3 py-1 bg-[var(--hide-600)] text-[var(--bone-400)] text-sm cursor-not-allowed"
                  >
                    Start Assessment
                  </button>
                </div>
          ...
          {activeTab === 'bio-checkin' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6 space-y-6">
                <h3 className="font-mono font-bold text-[var(--brass-300)] uppercase">Daily Biological Check-In</h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-semibold text-[var(--bone-400)] block mb-2" htmlFor="bio-sleep-hours">Sleep (4-12 hours)</label>
                    <input id="bio-sleep-hours" type="range" min="4" max="12" step="0.5" value={sleepHours} onChange={(e) => setSleepHours(Number.parseFloat(e.target.value))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                    <p className="text-xs text-[var(--bone-400)] mt-1">{sleepHours} hours</p>
                  </div>
                  <div>
                    <label className="text-sm font-semibold text-[var(--bone-400)] block mb-2" htmlFor="bio-hydration">Hydration (1-10)</label>
                    <input id="bio-hydration" type="range" min="1" max="10" value={hydrationStatus} onChange={(e) => setHydrationStatus(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                    <p className="text-xs text-[var(--bone-400)] mt-1">{hydrationStatus}/10</p>
                  </div>
                  <div>
                    <label className="text-sm font-semibold text-[var(--bone-400)] block mb-2" htmlFor="bio-motivation">Motivation (1-10)</label>
                    <input id="bio-motivation" type="range" min="1" max="10" value={motivation} onChange={(e) => setMotivation(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                    <p className="text-xs text-[var(--bone-400)] mt-1">{motivation}/10</p>
                  </div>
                  <div>
                    <label className="text-sm font-semibold text-[var(--bone-400)] block mb-2" htmlFor="bio-soreness">Soreness (0-10)</label>
                    <input id="bio-soreness" type="range" min="0" max="10" value={soreness} onChange={(e) => setSoreness(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                    <p className="text-xs text-[var(--bone-400)] mt-1">{soreness}/10</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-[var(--hide-600)] hover:bg-[var(--hide-500)] text-[var(--bone-200)] font-semibold transition"
                >
                  {expandedCheckIn ? '− Collapse' : '+ Expand to Maximum Check-In'}
                </button>

                {expandedCheckIn && (
                  <div className="space-y-4 pt-4 border-t-2 border-[var(--patina-700)]">
                    <p className="text-sm text-[var(--bone-400)]">Additional detailed metrics available below...</p>
                    <div className="text-xs text-[var(--bone-400)]">
          ...
          {activeTab === 'drill-library' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {drills.map(drill => (
                  <div key={drill.id} className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-4 space-y-3">
                    <div className="flex justify-between items-start">
                      <div>
                        <span className="inline-block text-xs font-mono font-bold bg-[var(--hide-600)] text-[var(--bone-400)] px-2 py-1 mb-2">{drill.category}</span>
                        <h4 className="text-base font-semibold">{drill.name}</h4>
                      </div>
                      <span className="text-xs font-mono text-[var(--brass-300)]">{drill.minRank}</span>
                    </div>
                    <p className="text-sm text-[var(--bone-400)]">{drill.focus}</p>
                    <div className="space-y-1">
                      <p className="text-xs font-semibold text-[var(--brass-300)]">Coaching Cues:</p>
                      <div className="flex flex-wrap gap-1">
                        {drill.cues.map((cue) => (
                          <span key={`${drill.id}-${cue}`} className="text-xs bg-[var(--hide-600)] text-[var(--bone-400)] px-2 py-1">⚡ {cue}</span>
                        ))}
                      </div>
                    </div>
                    <button
                      ...
                      className={`w-full py-2 rounded font-semibold transition ${
                        completedDrills[drill.id]
                          ...
                          : 'bg-[var(--hide-600)] hover:bg-[var(--hide-500)] text-[var(--bone-400)]'
                      }`}
                    >
          ...
          {activeTab === 'rabbit-holes' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6 space-y-4 animate-fadeIn">
                ...
                <p className="text-[var(--bone-400)]"><strong>Concept:</strong> Power does not generate in the shoulders. Force begins with rear-foot ground rotation through hip rotation into target through clean wrist extension.</p>
                <div className="bg-[var(--hide-950)] border-2 border-[var(--patina-700)] p-4">
                  <p className="text-sm text-[var(--bone-200)]"><strong>Homework:</strong> Complete 30 slow shadowboxing crosses, holding full extension for 3 seconds to confirm your rear foot heel is rotated fully outward.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'message-coach' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-6 space-y-4">
                <h3 className="font-mono font-bold text-[var(--brass-300)]">Send Message to Coach</h3>
                <form onSubmit={handleSendCoachMessage} className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-[var(--hide-950)] border-2 border-[var(--patina-700)] text-[var(--bone-200)] focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-24 px-3 py-2 bg-[var(--hide-950)] border-2 border-[var(--patina-700)] text-[var(--bone-200)] focus:outline-none resize-none"
                    />
                  </div>
                  {coachMessageStatus ? <p className="text-xs text-[var(--brass-300)]">{coachMessageStatus}</p> : null}
                  <button
                    type="submit"
                    disabled={isSendingCoachMessage}
                    className="w-full bg-[var(--patina-700)] hover:bg-[var(--rust-500)] disabled:bg-[var(--hide-600)] text-white font-semibold py-2 transition"
                  >
          ...
          {activeTab === 'schedule-session' && (
            <div className="space-y-6 animate-fadeIn">
              <div className="flex flex-wrap gap-2">
                <Link
                  href="/schedule"
                  className="inline-flex min-h-[40px] items-center border-2 border-[var(--patina-700)] bg-[var(--rust-900)] px-3 text-xs font-mono font-bold uppercase tracking-[0.1em] text-[var(--bone-200)] transition hover:bg-[var(--rust-700)]"
                >
          ...
          {activeTab === 'shadow' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="border-2 border-[var(--brass-500)] bg-[var(--hide-950)] p-6 space-y-4">
                <div>
                  <p className="text-sm font-semibold text-[var(--brass-300)]">SHADOW Chat</p>
                  <p className="mt-1 text-sm text-[var(--bone-400)]">
                ...
                <div className="space-y-2 border-t-2 border-[var(--brass-500)] pt-4">
                  <p className="text-sm font-semibold text-[var(--brass-300)]">Things you can ask SHADOW:</p>
                  <ul className="list-disc space-y-1 pl-5">
                    {suggestedQuestions.map((q) => (
                      <li key={q} className="text-sm text-[var(--bone-400)]">{q}</li>
                    ))}
                  </ul>
                </div>
              </div>
              ...
              <div className="border-2 border-[var(--patina-700)] bg-[var(--hide-900)] p-4">
                <h3 className="font-mono text-xs font-bold uppercase tracking-[0.08em] text-[var(--brass-300)]">SHADOW Observation Projection</h3>
                ...
                {!shadowObservationError && shadowObservations.length === 0 ? (
                  <p className="mt-2 text-xs text-[var(--bone-400)]">No SHADOW observations available yet.</p>
                ) : null}
                <div className="mt-2 space-y-2">
                  {shadowObservations.slice(0, 6).map((item) => (
                    <div key={item.id} className="border border-[var(--hide-500)] bg-[var(--hide-950)] p-2 text-xs text-[var(--bone-300)]">
                      <p className="font-semibold text-[var(--bone-200)]">{item.label}</p>
        ...
        {showPainModal && selectedPainLocation && (
          <div className="fixed inset-0 bg-[var(--hide-950)]/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-[var(--hide-950)] border-2 border-[var(--patina-700)] p-6 max-w-md w-full space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <select id="pain-type-select" value={currentPainType} onChange={(e) => setCurrentPainType(e.target.value as PainType)} className="w-full px-3 py-2 bg-[var(--hide-950)] border-2 border-[var(--patina-700)] text-[var(--bone-200)] focus:outline-none">
                ...
                <div>
                  ...
                  <input id="pain-severity-range" type="range" min="1" max="10" value={currentPainSeverity} onChange={(e) => setCurrentPainSeverity(Number.parseInt(e.target.value, 10))} className="w-full h-2 bg-[var(--hide-600)] accent-[var(--brass-500)]" />
                  <p className="text-xs text-[var(--bone-400)] mt-1">{currentPainSeverity}/10</p>
                </div>
              </div>
              <div className="flex gap-2">
                <button

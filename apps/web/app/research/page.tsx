  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
          <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-violet-300">Q&A Chat</p>
          <p className="mt-2 text-sm leading-6 text-slate-300">Ask questions about training science, platform capabilities, SHADOW specs, and research methodology.</p>
        </div>
      </div>
    </FeatureSurface>
  );

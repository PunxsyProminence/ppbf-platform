...
export default function SparringTelemetryPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // no client caller and no coach surface queries these rows. What IS true
      // is that the safety exceptions alert a coach (missing clearance /
      // contact during a hold file a flagged near miss) -- so that branch may
      // keep saying so, and does.

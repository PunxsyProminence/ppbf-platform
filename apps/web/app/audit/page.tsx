    ...
    >
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="border-2 border-[#8b4444] bg-[#1a1a1a]/60 p-4">
          <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-[#d4a574]">Change log</p>
          <p className="mt-2 text-sm leading-6 text-[#e8d7c6]">Surface for reviewing configuration diffs, manual overrides, and state transitions.</p>
        </div>
        <div className="border-2 border-[#8b4444] bg-[#1a1a1a]/60 p-4">
          <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-[#d4a574]">Reason registry</p>
          <p className="mt-2 text-sm leading-6 text-[#e8d7c6]">Pairs each override with a reason field so governance can audit decisions later.</p>
        </div>
      </div>
    </FeatureSurface>
  );

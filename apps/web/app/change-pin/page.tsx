            ...
            <form onSubmit={submit} className="mt-[var(--s5)] space-y-[var(--s5)]">
              ...
              <div className="field">
                ...
                {/* Naming 123456 was guidance when every athlete started on it.
                    They each get their own starting PIN now, so the thing to say
                    is what the server will actually refuse: the PIN they were
                    handed, and easy patterns generally. */}
                <p className="t-muted mb-[var(--s3)]">

    ...
    <main className="grid min-h-screen place-items-center bg-[var(--canvas-tan)] px-4 py-8 text-[var(--black)]">
      <div className="w-full max-w-md space-y-5">
        <header className="border-2 border-[var(--black)] bg-[var(--canvas-tan-light)] p-6 shadow-[var(--shadow-md)]">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--red-primary)]">First sign-in</p>
        ...
        <form onSubmit={submit} className="space-y-4 border-2 border-[var(--black)] bg-[var(--canvas-tan-light)] p-6 shadow-[var(--shadow-sm)]">
          {error && (
            <p role="alert" className="tactical-alert-critical text-sm font-semibold">
              {error}
            </p>
          )}
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 min-h-[48px] w-full border-2 border-[var(--black)] bg-[var(--canvas-tan-light)] px-3 font-mono tracking-[0.3em] focus:border-[var(--red-primary)] focus:outline-none focus:ring-2 focus:ring-[rgba(184,59,52,0.2)]"
            />
          </div>
          ...
          <button
            ...
            className="min-h-[50px] w-full border-2 border-[var(--red-primary)] bg-[var(--red-primary)] px-4 text-sm font-black uppercase tracking-[0.14em] text-white disabled:cursor-not-allowed disabled:opacity-50"
          >

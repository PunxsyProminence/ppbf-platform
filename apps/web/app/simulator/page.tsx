    ...
    >
      <div className="grid gap-4 lg:grid-cols-2">
        {scenarios.map((scenario) => (
          <article key={scenario.title} className="border-2 border-[color:var(--brass-700)] bg-[var(--hide-900)]/60 p-4">
            <p className="text-[16px] font-bold text-[color:var(--bone-200)]">{scenario.title}</p>
            <div className="mt-2 space-y-2 text-[14px] text-[color:var(--bone-300)]">
              <p><span className="font-semibold text-[color:var(--brass-300)]">Current State:</span> {scenario.currentState}</p>
              <p><span className="font-semibold text-[color:var(--brass-300)]">Proposed Change:</span> {scenario.proposedChange}</p>
              <p><span className="font-semibold text-[color:var(--brass-300)]">Expected Outcome:</span> {scenario.expectedOutcome}</p>
              <p>
                <span className="font-semibold text-[color:var(--brass-300)]">Risk Rating:</span>{' '}

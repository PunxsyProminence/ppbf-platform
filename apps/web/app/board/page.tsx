...
export default function BoardHubPage() {
  return (
    <main className="room--board min-h-screen bg-[var(--hide-950)] text-[var(--bone-200)]">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-10 lg:px-10">
        <header className="flex flex-col gap-4 border-b-4 border-[var(--patina-700)] pb-6 md:flex-row md:items-end md:justify-between">
          <div className="space-y-3">
            <p className="text-xs font-mono uppercase tracking-[0.35em] text-[var(--brass-300)]/80">Board Hub</p>
        ...
        <section className="mt-8 border-2 border-[var(--patina-700)] bg-[var(--hide-950)] p-5">
          <h2 className="text-lg font-black text-[var(--bone-200)]">Aggregate boundary</h2>

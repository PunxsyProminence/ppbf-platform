    ...
    >
      <div className="space-y-4">
        ...
        <section className="border-2 border-[var(--black)] bg-[var(--canvas-tan-light)] p-4">
          <p className="text-[12px] font-mono uppercase tracking-[0.16em] text-[var(--red-primary)]">Workflow Surface Registry</p>
          <div className="mt-3 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {workflowPanels.map((stage) => (
              <article key={stage} className="border border-[var(--black)] bg-[var(--canvas-tan)] p-3">
                <p className="text-[14px] font-semibold text-[var(--black)]">{stage}</p>

    ...
    <main className="min-h-screen bg-[var(--canvas-tan)] px-6 py-10 text-[var(--black)]">
      <div className="mx-auto max-w-5xl">
        <header className="border-b-[3px] border-[var(--black)] pb-6">
          <p className="text-xs font-mono uppercase tracking-[0.22em] text-[var(--safety-locked)]">Coach</p>
        ...
        <section className="mt-8 rounded-2xl border-2 border-[var(--black)] bg-white p-6">
          ...
          <button
            ...
            disabled={saving}
            className="mt-5 min-h-[48px] rounded-xl border-2 border-[var(--black)] bg-[var(--safety-locked)] px-6 text-sm font-black uppercase tracking-[0.14em] text-white disabled:cursor-not-allowed disabled:opacity-60"
          >
            ...
            {drills.map((drill) => (
              <article key={drill.drill_id} className="rounded-2xl border-2 border-[var(--black)] bg-white p-4">
                <div className="flex items-baseline justify-between gap-2">
                  ...
                  <span className="text-[11px] font-mono uppercase tracking-[0.1em] text-[var(--safety-locked)]">
                    {drill.difficulty}
                  </span>
                </div>

              ...
              {videos.map((v) => (
                <div key={v.video_session_id} className="flex items-center justify-between border border-[#5a4a3a] bg-[#101010] p-3">
                  ...
                  <div className="ml-4 flex shrink-0 items-center gap-2">
                    {canRelease(v) ? (
                      <>
                        <button onClick={() => { void previewForRelease(v.video_session_id, v.title); }} disabled={previewingVideoId === v.video_session_id} className="border border-[#c9a227] bg-[#241f10] px-3 py-1 text-xs font-mono text-[#c9a227] disabled:opacity-50">

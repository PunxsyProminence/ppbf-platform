...
export default function AdminCapabilitiesPage() {
  ...
  return (
    <RoleSessionGate allowedRoles={['admin', 'platform_owner']}>
      <main className="room--office min-h-screen bg-[var(--hide-950)] text-[var(--bone-200)]">
        <header className="border-b-4 border-[var(--patina-700)] bg-[var(--hide-900)] px-6 py-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <p className="text-[12px] font-mono uppercase tracking-[0.16em] text-[var(--brass-300)]">PPBF ADMIN AUTHORITY CONSOLE</p>
              <h1 className="mt-2 font-display text-[32px] font-black tracking-tight text-[var(--bone-100)]">Capability Management Console</h1>
              <p className="mt-2 max-w-4xl text-[16px] leading-7 text-[var(--bone-300)]">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {canManagePeople && (
                <Link
                  href="/admin/people"
                  className="inline-flex h-11 items-center border border-[var(--patina-700)] bg-[var(--rust-500)] px-4 text-[14px] font-bold text-[var(--bone-100)] transition hover:bg-[var(--rust-500)]"
                >
                  PEOPLE
                </Link>
              )}
              ...
              */}
              {canManagePeople && (
                <Link
                  ...
                  className="inline-flex h-11 items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-4 text-[14px] font-bold text-[var(--bone-100)] transition hover:bg-[var(--rust-900)]"
                >
                  VIDEO UPLOAD
                </Link>
              )}
              <Link
                href="/operations"
                className="inline-flex h-11 items-center border border-[var(--hide-500)] bg-[var(--hide-950)] px-4 text-[14px] font-bold text-[var(--bone-300)] transition hover:border-[var(--patina-700)]"
              >
                MISSION CONTROL
              </Link>
              {canOpenComplianceCenter && (
                <Link
                  ...
                  className="inline-flex h-11 items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-4 text-[14px] font-bold text-[var(--brass-300)] transition hover:bg-[var(--rust-900)]"
                >
              ...
              <button
                ...
                className="inline-flex h-11 items-center border border-[var(--patina-700)] bg-[var(--hide-950)] px-4 text-[14px] font-bold text-[var(--brass-300)] transition hover:border-[var(--brass-500)]"
              >
                EXPORT JSON
              </button>
            </div>
        ...
        <section className="border-b border-[var(--hide-600)] bg-[var(--hide-950)] px-6 py-3 text-[14px] text-[var(--bone-400)]">
        ...
        {(capabilityStoreError || gymCapabilityStoreError) && (
          <section role="alert" className="border-b border-[var(--patina-700)] bg-[var(--rust-900)] px-6 py-3 text-[14px] text-[var(--locked-ink)]">
        ...
        <div className="mx-auto max-w-[1500px] space-y-8 px-6 py-8">
          <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
            {[
              ...
              <article key={card.label} className="border border-[var(--hide-700)] bg-[var(--hide-900)] px-4 py-4">
                <p className="text-[12px] font-mono uppercase tracking-[0.16em] text-[var(--brass-300)]">{card.label}</p>
                <p className="mt-2 text-[30px] font-black text-[var(--bone-100)]">{card.value}</p>
              </article>
            ))}
          </section>

          <section className="flex flex-wrap gap-2 border border-[var(--hide-700)] bg-[var(--hide-950)] p-2">
            {[
              ...
              <button
                ...
                className={`h-11 border px-4 text-[14px] font-bold ${
                  activeTab === tab.id
                    ? 'border-[var(--patina-700)] bg-[var(--rust-500)] text-[var(--bone-100)]'
                    : 'border-[var(--hide-700)] bg-[var(--hide-900)] text-[var(--bone-300)] hover:border-[var(--patina-700)]'
                }`}
              >
                {tab.label}
              </button>
          ...
          {activeTab === 'overview' && (
            <section className="grid gap-6">
              <article className="border border-[var(--patina-700)] bg-[var(--hide-900)] p-6">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <h2 className="text-[24px] font-bold text-[var(--bone-100)]">Tutorial Access</h2>
                    <p className="mt-2 text-[14px] leading-6 text-[var(--bone-300)]">
              ...
              <article className="border border-[var(--hide-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Operational Overview</h2>
                <div className="mt-4 grid gap-4 lg:grid-cols-2">
                  <div className="space-y-3">
                    <h3 className="text-[18px] font-semibold text-[var(--bone-100)]">Recently Updated Capabilities</h3>
                    {recentlyUpdated.map((capability) => (
                      <div key={capability.id} className="border border-[var(--hide-800)] bg-[var(--hide-900)] px-4 py-3">
                        <p className="text-[16px] font-semibold text-[var(--bone-100)]">{capability.capabilityId} - {capability.name}</p>
                        <p className="text-[14px] text-[var(--bone-300)]">{capability.group} • {capability.status}</p>
                      </div>
                    ))}
                  </div>

                  <div className="space-y-3">
                    <h3 className="text-[18px] font-semibold text-[var(--bone-100)]">Role Exposure Snapshot</h3>
                    {roleExposureSnapshot.map((item) => (
                      <div key={item.role} className="flex items-center justify-between border border-[var(--hide-800)] bg-[var(--hide-900)] px-4 py-3">
                        <p className="text-[16px] text-[var(--bone-100)]">{item.role}</p>
                        <p className="text-[16px] font-bold text-[var(--brass-300)]">{item.count}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <article className="border border-[var(--hide-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Workload Buckets</h2>
                <div className="mt-4 grid gap-4 md:grid-cols-3">
                  <div className="border border-[var(--hide-800)] bg-[var(--hide-900)] p-4">
                    <p className="text-[18px] font-semibold text-[var(--bone-100)]">Capabilities Missing Assignments</p>
                    <p className="mt-2 text-[28px] font-black text-[var(--brass-300)]">{missingAssignments.length}</p>
                  </div>
                  <div className="border border-[var(--hide-800)] bg-[var(--hide-900)] p-4">
                    <p className="text-[18px] font-semibold text-[var(--bone-100)]">Capabilities Pending Review</p>
                    <p className="mt-2 text-[28px] font-black text-[var(--brass-300)]">{pendingReview.length}</p>
                  </div>
                  <div className="border border-[var(--hide-800)] bg-[var(--hide-900)] p-4">
                    <p className="text-[18px] font-semibold text-[var(--bone-100)]">Capabilities Marked Draft</p>
                    <p className="mt-2 text-[28px] font-black text-[var(--brass-300)]">{draftCapabilities.length}</p>
                  </div>
                </div>
              </article>

              <article className="border border-[var(--patina-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Critical Missing Capability Front-End Surfaces</h2>
                <p className="mt-2 text-[14px] leading-6 text-[var(--bone-300)]">
                  PLANNED | FRONT-END PLACEHOLDER | NOT YET AUTOMATED | BACKEND REQUIRED
                </p>
                <div className="mt-4 grid gap-3 md:grid-cols-2">
                  <Link href="/public" className="inline-flex min-h-[44px] items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-3 text-[13px] font-bold text-[var(--bone-100)] transition hover:bg-[var(--rust-900)]">
                    Edit Public Page Surface
                  </Link>
                  <Link href="/login" className="inline-flex min-h-[44px] items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-3 text-[13px] font-bold text-[var(--bone-100)] transition hover:bg-[var(--rust-900)]">
                    Manage Login Announcements
                  </Link>
                  {canOpenComplianceCenter && (
                    <Link href="/admin/compliance-center" className="inline-flex min-h-[44px] items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-3 text-[13px] font-bold text-[var(--bone-100)] transition hover:bg-[var(--rust-900)]">
                      Automated Compliance Monitoring Surface
                    </Link>
                  )}
                  <Link href="/source-control/publication-workflow" className="inline-flex min-h-[44px] items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-3 text-[13px] font-bold text-[var(--bone-100)] transition hover:bg-[var(--rust-900)]">
              ...
              <article className="border border-[var(--patina-700)] bg-[var(--hide-900)] p-6">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Capability On/Off Switchboard</h2>
                    <p className="mt-2 text-[14px] leading-6 text-[var(--bone-300)]">
                  ...
                  <Link
                    href="/admin/organizations"
                    className="inline-flex h-11 items-center border border-[var(--patina-700)] bg-[var(--hide-900)] px-4 text-[13px] font-bold text-[var(--brass-300)] transition hover:bg-[var(--rust-900)]"
                  >
                ...
                <div className="mt-5 grid gap-4 lg:grid-cols-2">
                  <div className="space-y-3">
                    <p className="text-[14px] font-semibold uppercase tracking-[0.12em] text-[var(--brass-300)]">Platform Control</p>
                    {switchboardCapabilities.map((capability) => {
                      const isOn = capability.status === 'ACTIVE';
                      return (
                        <div key={capability.id} className="flex items-center justify-between gap-3 border border-[var(--hide-800)] bg-[var(--hide-900)] px-4 py-3">
                          <div>
                            <p className="text-[16px] font-semibold text-[var(--bone-100)]">{capability.capabilityId} - {capability.name}</p>
                            <p className="text-[13px] text-[var(--bone-300)]">{capability.group} • {capability.status}</p>
                          </div>
                          <button
                            type="button"
                            ...
                            className={`inline-flex h-10 items-center rounded-full border px-4 text-[12px] font-bold uppercase tracking-[0.12em] transition ${
                              isOn
                                ? 'border-[var(--patina-700)] bg-[var(--rust-500)] text-[var(--bone-100)]'
                                : 'border-[var(--hide-800)] bg-[var(--hide-950)] text-[var(--bone-300)] hover:border-[var(--patina-700)]'
                            }`}
                          >
                            {isOn ? 'On' : 'Off'}
                          </button>
                  ...
                  <div className="space-y-3">
                    <p className="text-[14px] font-semibold uppercase tracking-[0.12em] text-[var(--brass-300)]">Gym Admin Access</p>
                    <p className="text-[14px] leading-6 text-[var(--bone-300)]">
                    ...
                    {switchboardCapabilities.map((capability) => {
                      ...
                      return (
                        <div key={capability.capabilityId} className="flex items-center justify-between gap-3 border border-[var(--hide-800)] bg-[var(--hide-900)] px-4 py-3">
                          <div>
                            <p className="text-[16px] font-semibold text-[var(--bone-100)]">{capability.capabilityId}</p>
                            <p className="text-[13px] text-[var(--bone-300)]">Gym admins can {allowed ? 'toggle this capability' : 'not yet toggle this capability'}.</p>
                          </div>
                          <button
                            type="button"
              ...
              <article className="border border-[var(--patina-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">FRONT-END TRACK ASSIGNMENT PREVIEW</h2>
                <p className="mt-2 text-[14px] leading-6 text-[var(--bone-300)]">
                  Active Track Assignments are displayed here in preview mode for capability planning and role exposure checks.
                </p>
                <div className="mt-4 grid gap-4 lg:grid-cols-[300px_1fr]">
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="athleteProfile">
                    ...
                    <select
                      ...
                      className="h-11 w-full border border-[var(--hide-700)] bg-[var(--hide-950)] px-3 text-[16px] text-[var(--bone-100)]"
                    >
                      ...
                      return (
                        <button
                          ...
                          className={`grid gap-2 border px-4 py-4 text-left ${
                            assigned
                              ? 'border-[var(--patina-700)] bg-[var(--rust-700)] text-[var(--bone-100)]'
                              : 'border-[var(--hide-800)] bg-[var(--hide-900)] text-[var(--bone-300)]'
                          }`}
                        >
                          ...
                          <span className="text-[14px] text-[var(--bone-400)]">{TRACK_CAPABILITY_PREVIEW[trackId].join(', ')}</span>
                        </button>
                      );
                    })}
                  </div>
          ...
          {activeTab === 'library' && (
            <section className="space-y-5">
              <article className="border border-[var(--hide-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Capability Library</h2>
                <div className="mt-4 grid gap-3 lg:grid-cols-3">
                  <input
                    ...
                    className="h-11 border border-[var(--hide-700)] bg-[var(--hide-950)] px-3 text-[16px] text-[var(--bone-100)]"
                  />
              ...
              <article className="border border-[var(--hide-700)] bg-[var(--hide-900)] p-0">
                <div className="divide-y divide-[var(--hide-800)] lg:hidden">
                    ...
                    return (
                      <div key={capability.id} className="space-y-3 px-4 py-4">
                        <div className="space-y-2">
                          <p className="text-[13px] font-mono uppercase tracking-[0.1em] text-[var(--brass-300)]">{capability.capabilityId}</p>
                          <h3 className="text-[18px] font-bold text-[var(--bone-100)]">{capability.name}</h3>
                          <p className="text-[14px] text-[var(--bone-300)]">Last updated: {formatDateLabel(capability.updatedAt)}</p>
                          <p className="text-[14px] text-[var(--bone-300)]">Category: {capability.group}</p>
                          <p className="text-[14px] text-[var(--bone-300)]">Roles: {capability.assignedRoles.length > 0 ? capability.assignedRoles.join(', ') : 'Unassigned'}</p>
                          <p className="text-[14px] text-[var(--bone-300)]">Status: {capability.status} | Visibility: {capability.visibility}</p>
                          <p className="text-[14px] text-[var(--bone-300)]">Owner: {capability.owner}</p>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <button
                            ...
                            className="h-11 border border-[var(--hide-700)] bg-[var(--hide-900)] px-3 text-[12px] font-bold text-[var(--bone-300)]"
                          >
                            VIEW
                          </button>
                          <button
                          ...
                          <button
                            ...
                            className="h-11 border border-[var(--patina-700)] bg-[var(--rust-900)] px-3 text-[12px] font-bold text-[var(--bone-100)]"
                          >
                            ASSIGN
                          </button>
                          <button
                            ...
                            className="h-11 border border-[var(--patina-700)] bg-[var(--rust-700)] px-3 text-[12px] font-bold text-[var(--bone-100)]"
                          >
                            ARCHIVE
                          </button>
                        </div>
                        ...
                        {expanded && (
                          <div className="border border-[var(--hide-800)] bg-[var(--hide-950)] px-4 py-4">
                            <p className="text-[16px] text-[var(--bone-300)]">{capability.description}</p>
                            <p className="mt-2 text-[14px] text-[var(--bone-400)]">Dependencies: {capability.dependencies || 'None listed'}</p>
                            <p className="mt-1 text-[14px] text-[var(--bone-400)]">Notes: {capability.notes || 'No additional notes'}</p>

                            {assignmentFocused && (
                              <div className="mt-4 space-y-2">
                                <p className="text-[14px] font-semibold uppercase tracking-[0.12em] text-[var(--brass-300)]">Role Assignment Controls</p>
                                <div className="flex flex-wrap gap-2">
                                  {ROLE_OPTIONS.map((role) => {
                                    ...
                                    return (
                                      <button
                                        ...
                                        className={`h-11 border px-3 text-[13px] font-bold ${
                                          assigned
                                            ? 'border-[var(--patina-700)] bg-[var(--rust-500)] text-[var(--bone-100)]'
                                            : 'border-[var(--hide-700)] bg-[var(--hide-900)] text-[var(--bone-300)]'
                                        }`}
                                      >
                                        {assigned ? '✓ ' : '— '}
                                        {role}
                            ...
                            <div className="mt-4 flex flex-wrap gap-2">
                              <button
                                ...
                                className="h-11 border border-[var(--hide-700)] bg-[var(--hide-900)] px-3 text-[13px] font-bold text-[var(--bone-300)]"
                              >
                                SET DRAFT
                              </button>
                              <button
                                ...
                                className="h-11 border border-[var(--patina-700)] bg-[var(--rust-500)] px-3 text-[13px] font-bold text-[var(--bone-100)]"
                              >
                                SET ACTIVE
                              </button>
                              <button
                                ...
                                className="h-11 border border-[var(--patina-700)] bg-[var(--rust-700)] px-3 text-[13px] font-bold text-[var(--bone-100)]"
                              >
                                SET BLOCKED
                              </button>
                              <button
                                ...
                                className="h-11 border border-[var(--patina-700)] bg-[var(--rust-900)] px-3 text-[13px] font-bold text-[var(--bone-100)]"
                              >
                                DELETE
                              </button>
                            </div>
                ...
                <div className="hidden overflow-x-auto lg:block">
                  <div className="min-w-[1260px]">
                    <div className="grid grid-cols-[100px_minmax(200px,1.3fr)_minmax(160px,1fr)_minmax(150px,1fr)_120px_130px_150px_170px] gap-2 border-b border-[var(--hide-700)] bg-[var(--hide-900)] px-4 py-3 text-[14px] font-semibold text-[var(--bone-300)]">
                      <span>ID</span>
                    ...
                    <div className="divide-y divide-[var(--hide-800)]">
                  {filteredCapabilities.map((capability) => {
                    const expanded = expandedCapabilityId === capability.id;
                    const assignmentFocused = assignmentFocusId === capability.id;
                    return (
                      <div key={capability.id} className="bg-[var(--hide-900)]">
                        <div className="grid grid-cols-[100px_minmax(200px,1.3fr)_minmax(160px,1fr)_minmax(150px,1fr)_120px_130px_150px_170px] gap-2 px-4 py-3 text-[14px] text-[var(--bone-100)]">
                          <span>{capability.capabilityId}</span>
                          <span>
                            <strong className="block text-[16px]">{capability.name}</strong>
                            <span className="text-[14px] text-[var(--bone-300)]">Last updated: {formatDateLabel(capability.updatedAt)}</span>
                          </span>
                          ...
                          <div className="flex flex-wrap gap-1">
                            <button
                              ...
                              className="h-11 border border-[var(--hide-700)] bg-[var(--hide-900)] px-2 text-[12px] font-bold text-[var(--bone-300)]"
                            >
                              VIEW
                            </button>
                            <button
                            ...
                            <button
                              ...
                              className="h-11 border border-[var(--patina-700)] bg-[var(--rust-900)] px-2 text-[12px] font-bold text-[var(--bone-100)]"
                            >
                              ASSIGN
                            </button>
                            <button
                              type="button"
                              onClick={() => setCapabilityStatus(capability.id, 'ARCHIVED')}
                              className="h-11 border border-[var(--patina-700)] bg-[var(--rust-700)] px-2 text-[12px] font-bold text-[var(--bone-100)]"
                            >
                              ARCHIVE
                            </button>
                          </div>
                        ...
                        {expanded && (
                          <div className="border-t border-[var(--hide-800)] bg-[var(--hide-950)] px-4 py-4">
                            <p className="text-[16px] text-[var(--bone-300)]">{capability.description}</p>
                            <p className="mt-2 text-[14px] text-[var(--bone-400)]">Dependencies: {capability.dependencies || 'None listed'}</p>
                            <p className="mt-1 text-[14px] text-[var(--bone-400)]">Notes: {capability.notes || 'No additional notes'}</p>
          ...
          {activeTab === 'matrix' && (
            <section className="space-y-5">
              <article className="border border-[var(--hide-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Assignment Matrix</h2>
                <div className="mt-4 flex flex-wrap gap-2">
                  {[
              ...
              <article className="overflow-x-auto border border-[var(--hide-700)] bg-[var(--hide-900)]">
                <table className="min-w-[1300px] border-collapse text-left">
                  <thead>
                    <tr className="border-b border-[var(--hide-700)] bg-[var(--hide-900)] text-[14px] uppercase tracking-[0.08em] text-[var(--bone-300)]">
                  ...
                  <tbody>
                    {matrixCapabilities.map((capability) => (
                      <tr key={capability.id} className="border-b border-[var(--hide-800)] text-[14px] text-[var(--bone-100)]">
                        ...
                        {ROLE_OPTIONS.map((role) => {
                          ...
                          let assignmentClass = 'border-[var(--hide-800)] bg-[var(--hide-900)] text-[var(--bone-300)]';
                          let marker = '—';
                          if (needsReview) {
                            assignmentClass = 'border-[var(--patina-700)] bg-[var(--rust-700)] text-[var(--bone-100)]';
                            marker = '⚠';
                          } else if (assigned) {
                            assignmentClass = 'border-[var(--patina-700)] bg-[var(--rust-500)] text-[var(--bone-100)]';
                            marker = '✓';
                          }
                          return (
          ...
          {activeTab === 'builder' && (
            <section className="space-y-5">
              <article className="border border-[var(--patina-700)] bg-[var(--hide-900)] p-6">
                <h2 className="text-[20px] font-bold text-[var(--bone-100)]">Capability Builder</h2>
                <p className="mt-2 text-[14px] leading-6 text-[var(--bone-300)]">
                ...
                <div className="mt-4 grid gap-4 lg:grid-cols-2">
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-name">Capability Name</label>
                    <input
                      id="builder-name"
                      value={builderName}
                  ...
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-capability-id">Capability ID</label>
                    <input
                  ...
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-category">Category</label>
                    <input
                      id="builder-category"
                  ...
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-owner">Owner / Steward</label>
                    <input
                      id="builder-owner"
                      value={builderOwner}
                  ...
                  <div className="lg:col-span-2">
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-description">Description</label>
                    <textarea
                      id="builder-description"
                      value={builderDescription}
                      onChange={(event) => setBuilderDescription(event.target.value)}
                      className="min-h-[110px] w-full border border-[var(--hide-700)] bg-[var(--hide-950)] px-3 py-2 text-[16px] text-[var(--bone-100)]"
                    />
                  </div>

                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-primary-role">Primary Role</label>
                    <select
                  ...
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-status">Status</label>
                    <select
                      id="builder-status"
                      value={builderStatus}
                  ...
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-visibility">Visibility</label>
                    <select
                  ...
                  <div>
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-dependencies">Dependencies</label>
                    <input
                  ...
                  <div className="lg:col-span-2">
                    <p className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]">Secondary Roles</p>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div className="lg:col-span-2">
                    <label className="mb-2 block text-[14px] font-semibold text-[var(--bone-300)]" htmlFor="builder-notes">Notes</label>
                    <textarea
                      id="builder-notes"
                      value={builderNotes}
                      onChange={(event) => setBuilderNotes(event.target.value)}
                      className="min-h-[90px] w-full border border-[var(--hide-700)] bg-[var(--hide-950)] px-3 py-2 text-[16px] text-[var(--bone-100)]"
                    />
                  </div>
                </div>
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  <button
                    ...
                    className="h-11 border border-[var(--patina-700)] bg-[var(--rust-500)] px-4 text-[14px] font-bold text-[var(--bone-100)]"
                  >
                    SAVE CAPABILITY
                  </button>
                  <button
                    ...
                    className="h-11 border border-[var(--hide-700)] bg-[var(--hide-900)] px-4 text-[14px] font-bold text-[var(--bone-300)]"
                  >
                    RESET FORM
                  </button>
                  <button
          ...
          <section className="border border-[var(--hide-700)] bg-[var(--hide-900)] p-4">
            <button
              type="button"
            ...
            {showTelemetry && (
              <div className="mt-3 max-h-[220px] overflow-y-auto border border-[var(--hide-800)] bg-[var(--hide-950)]">
                {eventTraces.length === 0 && <p className="px-4 py-3 text-[14px] text-[var(--bone-400)]">No traces yet.</p>}
                {eventTraces.map((trace, index) => (
                  <div key={`${trace.timestamp}-${index}`} className="border-b border-[var(--hide-800)] px-4 py-3 text-[14px] text-[var(--bone-400)]">
                    <span className="font-mono text-[var(--brass-300)]">[{trace.timestamp}]</span> {trace.action} - {trace.detail}
                  </div>
                ))}
              </div>
            )}
            ...
            <div className="mt-4">
              ...
              {showIntegrationStubs && (
                <div className="mt-3 border border-[var(--hide-800)] bg-[var(--hide-950)]">
                  {INTEGRATION_STUBS.map((item) => (
                    <div key={item} className="border-b border-[var(--hide-800)] px-4 py-3 text-[14px] text-[var(--bone-400)] last:border-b-0">
                      {item}
                    </div>
                  ))}
                </div>

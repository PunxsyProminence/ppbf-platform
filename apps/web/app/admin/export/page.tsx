        ...
        <div className="mx-auto w-full max-w-4xl px-6 py-10 lg:px-10">
          ...
          <section className="mt-8 border-[3px] border-[var(--black)] bg-[var(--canvas-tan-light)] p-5">
            <button
              ...
              className="min-h-[48px] w-full border-2 border-[var(--black)] bg-[var(--accent-strong)] px-6 text-sm font-black uppercase tracking-[0.12em] text-[var(--accent-ink)] disabled:cursor-not-allowed disabled:opacity-50"
            >
          ...
          <section className="mt-8">
            ...
            <ul className="mt-3 space-y-2 text-sm leading-6 text-[var(--gray-dark)]">
              <li className="border-l-4 border-[var(--accent)] pl-3">

...
function SubmissionCard({ item, scope, onTriage }: SubmissionCardProps) {
  ...
  return (
    <article
      className={
        isSafeguarding
          ? 'border-[3px] border-[var(--safety-locked)] bg-[var(--canvas-tan-light)] p-4 shadow-[var(--shadow-md)]'
          : 'border-2 border-[var(--black)] bg-[var(--canvas-tan-light)] p-4'
      }
    >
      {isSafeguarding ? (
        <p className="mb-3 border-2 border-[var(--black)] bg-[var(--safety-locked)] px-2 py-1 text-[11px] font-mono font-bold uppercase tracking-[0.14em] text-[var(--white)]">
      ...
      <div className="flex flex-wrap items-center gap-2 text-[11px] font-mono uppercase tracking-[0.12em] text-[var(--gray-dark)]">
        ...
        <span className="text-[var(--safety-locked)]">{item.triage_status}</span>
      </div>
      ...
      {scope === 'organization' ? (
        <div className="mt-4 space-y-2 border-t-2 border-[var(--black)] pt-3">
          ...
          <button
            ...
            className="min-h-[44px] w-full border-2 border-[var(--black)] bg-[var(--safety-locked)] px-4 text-xs font-black uppercase tracking-[0.12em] text-[var(--white)] disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <div className="mx-auto w-full max-w-5xl px-6 py-10 lg:px-10">
          ...
          {safeguarding.length > 0 ? (
            <section className="mt-6">
              <div className="border-[3px] border-[var(--black)] bg-[var(--safety-locked)] px-4 py-3">

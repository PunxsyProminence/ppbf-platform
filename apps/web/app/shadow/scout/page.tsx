    ...
    <main className="min-h-screen bg-[var(--hide-950)] text-[color:var(--bone-200)]">
      ...
      <header className="border-b-4 border-[color:var(--brass-700)] bg-[var(--hide-900)] px-4 py-4 md:px-8">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-4">
          <div>
            <p className="text-[length:var(--t-xs)] font-mono uppercase tracking-[0.3em] text-[color:var(--locked-ink)]">SHADOW Intelligence</p>
      ...
      <div className="mx-auto max-w-5xl p-4 md:p-8 space-y-6">
        ...
        <section className="border-2 border-[color:var(--brass-700)] bg-[var(--hide-950)] p-5">
          ...
          <div className="mt-3 border border-[color:var(--hide-600)] bg-[var(--hide-950)] p-3">
            <label htmlFor="generate-focus" className="block text-[length:var(--t-xs)] font-mono uppercase tracking-[0.14em] text-[var(--bone-400)]">
              ...
              {scoutJobs.map((job) => (
                ...
                >
                  ...
                  {selectedJob?.jobId === job.jobId && job.status === 'failed' ? (
                    <p className="mt-2 text-[length:var(--t-xs)] font-mono text-[color:var(--locked-ink)]">Error: {job.error}</p>
                  ) : null}

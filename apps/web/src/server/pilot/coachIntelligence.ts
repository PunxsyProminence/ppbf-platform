...
// board's). Importing the constant only keeps the NUMBER from drifting --
// the comparison built around it has to be copied by hand, so item 3's
// fading-attendance filter below is written to match

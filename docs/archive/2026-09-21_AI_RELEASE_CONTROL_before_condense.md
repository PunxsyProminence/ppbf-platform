> **ARCHIVED 2026-09-21.** Verbatim text of `docs/current/AI_RELEASE_CONTROL.md` at `38fb9676c57495ab96d3d78c3612abf705874e4a`, before it was
> condensed. History and provenance only: the current rules are in `docs/current/AI_RELEASE_CONTROL.md`.

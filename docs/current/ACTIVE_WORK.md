...
| SHADOW near-miss text in athlete/parent chats | Recorded 2026-08-28 as FOR THE OWNER: SHADOW injects near-miss text into athlete/parent chats that `GET /near-misses` denies those roles. Not re-checked since. | An owner decision on whether those roles may see near-miss text. |
